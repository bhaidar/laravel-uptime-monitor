...
const onDeleteSite = () => {
  if (window.confirm('Are you sure you want to delete this site?')) {
    Inertia.delete(route('sites.destroy', { site: props?.site?.data }));
  }
};
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
              <template v-if="site?.data">
                ...
                <div class="mt-8">
                  <PrimaryButton class="shrink-0 h-9 bg-red-500 text-white text-sm" @click="onDeleteSite">Delete site</PrimaryButton>
                </div>
              </template>
              <template v-else>
                No sites found!
